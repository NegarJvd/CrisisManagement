        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex flex-row dark:text-gray-100">
                    ...
                    <a href="{{route('shelter_seekers')}}" class="basis-1/4 group block max-w-xs mx-auto rounded-lg p-6 mr-2 ml-2 ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-gray-100 hover:ring-gray-100">
                        <div class="items-center text-center">
