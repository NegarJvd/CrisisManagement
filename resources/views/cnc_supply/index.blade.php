    ...
    <x-slot name="header">
        <div class="flex flex-row justify-between">
            ...
            <div class="flex flex-row justify-center text-center">
                <a class="border border-slate-600 p-1 rounded-lg hover:bg-gray-100" href="{{route('cnc-supply.create')}}">Create new</a>
            </div>
        </div>
    </x-slot>
                                ...
                                <tr class="border border-slate-600 py-3">
                                    ...
                                    <td class="py-3 flex flex-row items-center justify-center">
                                        <div class="basis-1/2 flex items-center justify-center">
                                            <a href="{{route('cnc-supply.edit', $cnc->id)}}" title="edit">
                                                <img class="w-4 hover:bg-gray-300" src="{{asset('/icons/edit.png')}}" alt="edit">
                                            </a>
                                        </div>
                                        <div class="basis-1/2 flex items-center justify-center">
                                            <form method="post" action="{{ route('cnc-supply.destroy', $cnc->id) }}" title="delete">
                                                @csrf
                                                @method('delete')
                                                <button type="submit">
