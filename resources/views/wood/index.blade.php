    ...
    <x-slot name="header">
        <div class="flex flex-row justify-between">
            ...
            <div class="flex flex-row justify-center text-center">
                <a class="border border-slate-600 p-1 rounded-lg hover:bg-gray-100" href="{{route('wood-management.create')}}">Create new material</a>
            </div>
        </div>
    </x-slot>
                                ...
                                @if(Auth::user()->is_admin)
                                    <td class="py-3 flex flex-row items-center justify-center">
                                        <div class="basis-1/2 flex items-center justify-center">
                                            <a href="{{route('wood-management.edit', $wood->id)}}" title="edit">
