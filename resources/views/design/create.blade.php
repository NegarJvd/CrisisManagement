        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 overflow-x-auto dark:text-gray-100">
                    <form method="post" action="{{ route('design.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf

                        <div class="flex flex-row">
                            <div class="basis-1/2 mr-2">
                                <x-input-label for="file" :value="__('File of design')" />
                                <x-text-input id="file" name="file" type="file" class="mt-1 block w-full p-1.5" required autofocus />
                                <x-input-error class="mt-2" :messages="$errors->get('file')" />
                            </div>

                            <div class="basis-1/2 ml-2">
                                <x-input-label for="number_of_households" :value="__('Number of households')" />
                                <x-text-input id="number_of_households" name="number_of_households" type="number" class="mt-1 block w-full" :value="old('number_of_households')" required autofocus autocomplete="number_of_households" />
                        ...
                        <div class="flex flex-row">
                            <div class="basis-1/3 mr-2">
                                ...
                                <x-text-input id="snow_load" name="snow_load" type="text" class="mt-1 block w-full" :value="old('snow_load')" required autofocus autocomplete="snow_load" />
                            ...
                            <div class="basis-1/3 mr-2 ml-2">
                                ...
                                <x-text-input id="wind_load" name="wind_load" type="text" class="mt-1 block w-full" :value="old('wind_load')" required autofocus autocomplete="wind_load" />
                            ...
                            <div class="basis-1/3 ml-2">
                                ...
                                <x-text-input id="earthquake_load" name="earthquake_load" type="text" class="mt-1 block w-full" :value="old('earthquake_load')" required autofocus autocomplete="earthquake_load" />
