<x-app-layout>
    ...
    <script type="module">
        $(document).ready(function() {
            $('#joint_1').on('click', function (){
                const url = "{!! env('FLASK_URL') !!}" + '/joint1';
            ...
            $('#joint_2').on('click', function (){
                const url = "{!! env('FLASK_URL') !!}" + '/joint2';
            ...
            $('#joint_4').on('click', function (){
                const url = "{!! env('FLASK_URL') !!}" + '/joint4';
                        ...
                        <div class="flex flex-row">
                            <div class="basis-1/2 mr-2">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="joint1_dtl_clm" name="joint1_dtl_clm" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint1_dtl_clm" required autofocus autocomplete="joint1_dtl_clm" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint1_dtl_clm')" />
                                </div>

                                <div>
                                    <x-input-label for="joint1_dtj_clm" :value="__('dtj_clm (mm)')" />
                                    <x-text-input id="joint1_dtj_clm" name="joint1_dtj_clm" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint1_dtj_clm" required autofocus autocomplete="joint1_dtj_clm" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint1_dtj_clm')" />
                                </div>

                                <div>
                                    <x-input-label for="joint1_btl_clm" :value="__('btl_clm (mm)')" />
                                    <x-text-input id="joint1_btl_clm" name="joint1_btl_clm" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint1_btl_clm" required autofocus autocomplete="joint1_btl_clm" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint1_btl_clm')" />
                                </div>

                                <div>
                                    <x-input-label for="joint1_ttl_clm" :value="__('ttl_clm (mm)')" />
                                    <x-text-input id="joint1_ttl_clm" name="joint1_ttl_clm" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint1_ttl_clm" required autofocus autocomplete="joint1_ttl_clm" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint1_ttl_clm')" />
                                </div>

                                <div>
                                    <x-input-label for="joint1_b_clm" :value="__('b_clm (mm)')" />
                                    <x-text-input id="joint1_b_clm" name="joint1_b_clm" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint1_b_clm" required autofocus autocomplete="joint1_b_clm" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint1_b_clm')" />
                                </div>

                                <div>
                                    <x-input-label for="joint1_dtt_clm" :value="__('dtt_clm (mm)')" />
                                    <x-text-input id="joint1_dtt_clm" name="joint1_dtt_clm" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint1_dtt_clm" required autofocus autocomplete="joint1_dtt_clm" />
                        ...
                        <div class="flex flex-row">
                            <div class="basis-1/2 mr-2">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="joint2_jc1" name="joint2_jc1" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint2_jc1" required autofocus autocomplete="joint2_jc1" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint2_jc1')" />
                                </div>

                                <div>
                                    <x-input-label for="joint2_jc2" :value="__('jc2 (mm)')" />
                                    <x-text-input id="joint2_jc2" name="joint2_jc2" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint2_jc2" required autofocus autocomplete="joint2_jc2" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint2_jc2')" />
                                </div>

                                <div>
                                    <x-input-label for="joint2_jc3" :value="__('jc3 (mm)')" />
                                    <x-text-input id="joint2_jc3" name="joint2_jc3" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint2_jc3" required autofocus autocomplete="joint2_jc3" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint2_jc3')" />
                                </div>

                                <div>
                                    <x-input-label for="joint2_jc4" :value="__('jc4 (mm)')" />
                                    <x-text-input id="joint2_jc4" name="joint2_jc4" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint2_jc4" required autofocus autocomplete="joint2_jc4" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint2_jc4')" />
                                </div>

                                <div>
                                    <x-input-label for="joint2_jc5" :value="__('jc5 (mm)')" />
                                    <x-text-input id="joint2_jc5" name="joint2_jc5" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint2_jc5" required autofocus autocomplete="joint2_jc5" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint2_jc5')" />
                                </div>

                                <div>
                                    <x-input-label for="joint2_jc6" :value="__('jc6 (mm)')" />
                                    <x-text-input id="joint2_jc6" name="joint2_jc6" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint2_jc6" required autofocus autocomplete="joint2_jc6" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint2_jc6')" />
                                </div>

                                <div>
                                    <x-input-label for="joint2_jc7" :value="__('jc7 (mm)')" />
                                    <x-text-input id="joint2_jc7" name="joint2_jc7" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint2_jc7" required autofocus autocomplete="joint2_jc7" />
                        ...
                        <div class="flex flex-row">
                            <div class="basis-1/2 mr-2">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="joint3_lim_e" name="joint3_lim_e" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint3_lim_e" required autofocus autocomplete="joint3_lim_e" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint3_lim_e')" />
                                </div>

                                <div>
                                    <x-input-label for="joint3_lim_s" :value="__('lim_s (mm)')" />
                                    <x-text-input id="joint3_lim_s" name="joint3_lim_s" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint3_lim_s" required autofocus autocomplete="joint3_lim_s" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint3_lim_s')" />
                                </div>

                                <div>
                                    <x-input-label for="joint3_lim_v" :value="__('lim_v (mm)')" />
                                    <x-text-input id="joint3_lim_v" name="joint3_lim_v" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint3_lim_v" required autofocus autocomplete="joint3_lim_v" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint3_lim_v')" />
                                </div>

                                <div>
                                    <x-input-label for="joint3_lim_g" :value="__('lim_g (mm)')" />
                                    <x-text-input id="joint3_lim_g" name="joint3_lim_g" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint3_lim_g" required autofocus autocomplete="joint3_lim_g" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint3_lim_g')" />
                                </div>

                                <div>
                                    <x-input-label for="joint3_d" :value="__('d (mm)')" />
                                    <x-text-input id="joint3_d" name="joint3_d" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint3_d" required autofocus autocomplete="joint3_d" />
                        ...
                        <div class="flex flex-row">
                            <div class="basis-1/2 mr-2">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="joint4_d" name="joint4_d" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_d" required autofocus autocomplete="joint4_d" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint4_d')" />
                                </div>

                                <div>
                                    <x-input-label for="joint4_btucl" :value="__('btucl (mm)')" />
                                    <x-text-input id="joint4_btucl" name="joint4_btucl" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_btucl" required autofocus autocomplete="joint4_btucl" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint4_btucl')" />
                                </div>

                                <div>
                                    <x-input-label for="joint4_ttu_clm" :value="__('ttu_clm (mm)')" />
                                    <x-text-input id="joint4_ttu_clm" name="joint4_ttu_clm" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_ttu_clm" required autofocus autocomplete="joint4_ttu_clm" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint4_ttu_clm')" />
                                </div>

                                <div>
                                    <x-input-label for="joint4_l_scr" :value="__('l_scr (mm)')" />
                                    <x-text-input id="joint4_l_scr" name="joint4_l_scr" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_l_scr" required autofocus autocomplete="joint4_l_scr" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint4_l_scr')" />
                                </div>

                                <div>
                                    <x-input-label for="joint4_esb" :value="__('esb (mm)')" />
                                    <x-text-input id="joint4_esb" name="joint4_esb" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_esb" required autofocus autocomplete="joint4_esb" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint4_esb')" />
                                </div>

                                <div>
                                    <x-input-label for="joint4_leu_sb" :value="__('leu_sb (mm)')" />
                                    <x-text-input id="joint4_leu_sb" name="joint4_leu_sb" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_leu_sb" required autofocus autocomplete="joint4_leu_sb" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint4_leu_sb')" />
                                </div>

                                <div>
                                    <x-input-label for="joint4_lsu_s_b" :value="__('lsu_s_b (mm)')" />
                                    <x-text-input id="joint4_lsu_s_b" name="joint4_lsu_s_b" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_lsu_s_b" required autofocus autocomplete="joint4_lsu_s_b" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint4_lsu_s_b')" />
                                </div>

                                <div>
                                    <x-input-label for="joint4_glsb" :value="__('glsb (mm)')" />
                                    <x-text-input id="joint4_glsb" name="joint4_glsb" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_glsb" required autofocus autocomplete="joint4_glsb" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint4_glsb')" />
                                </div>

                                <div>
                                    <x-input-label for="joint4_tb" :value="__('tb (mm)')" />
                                    <x-text-input id="joint4_tb" name="joint4_tb" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_tb" required autofocus autocomplete="joint4_tb" />
                                    <x-input-error class="mt-2" :messages="$errors->get('joint4_tb')" />
                                </div>

                                <div>
                                    <x-input-label for="joint4_wb" :value="__('wb (mm)')" />
                                    <x-text-input id="joint4_wb" name="joint4_wb" type="number" step="0.01" class="mt-1 block w-full" :value="$design->joint4_wb" required autofocus autocomplete="joint4_wb" />
