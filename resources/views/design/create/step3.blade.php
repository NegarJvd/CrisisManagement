                    ...
                    <form method="post" action="{{ route('design.store.step3') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-row">
                            <div class="basis-1/3 mr-2">
                                ...
                                <x-text-input id="snow_load" name="snow_load" type="number" step="0.1" class="mt-1 block w-full" :value="$design->snow_load" required autofocus autocomplete="snow_load" />
                            ...
                            <div class="basis-1/3 mr-2 ml-2">
                                ...
                                <x-text-input id="wind_load" name="wind_load" type="number" step="0.1" class="mt-1 block w-full" :value="$design->wind_load" required autofocus autocomplete="wind_load" />
                                <x-input-error class="mt-2" :messages="$errors->get('wind_load')" />
                            </div>

                            <div class="basis-1/3 mr-2 ml-2">
                                <x-input-label for="dead_load" :value="__('Dead load')" />
                                <x-text-input id="dead_load" name="dead_load" type="number" step="0.1" class="mt-1 block w-full" :value="$design->dead_load" required autofocus autocomplete="dead_load" />
                            ...
                            <div class="basis-1/3 ml-2">
                                ...
                                <x-text-input id="live_load" name="live_load" type="number" step="0.1" class="mt-1 block w-full" :value="$design->live_load" required autofocus autocomplete="live_load" />
